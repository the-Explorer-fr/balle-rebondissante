...
class BallTrail:
    ...
    def draw(self, screen, transparence):
        ...
        # Cercle noir légèrement transparent (90% de la taille)
        inner_radius = max(1, int(self.radius * 0.95))
        pygame.draw.circle(circle_trail, (0, 0, 0, transparence), (self.radius, self.radius), inner_radius)
